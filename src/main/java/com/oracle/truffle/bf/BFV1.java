...
public class BFV1 extends BFImpl {
    ...
    private class OperationNode extends Node {
        ...
        OperationNode(OpCode opCode, OperationNode[] children) {
            this.opCode = opCode;
            this.children = children;
        }

        @CompilerDirectives.CompilationFinal private boolean seenExpansion;
        ...
        @CompilerDirectives.TruffleBoundary
        private void output(int what) throws IOException {
            out.write(what);
        }
